...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="section-shell relative overflow-hidden bg-ivory">
        ...
        <div className="mx-auto mt-14 grid max-w-6xl gap-5 sm:grid-cols-2 sm:gap-7 lg:grid-cols-3">
          {galleryItems.map((item, index) => (
            ...
            >
              ...
              <div className="absolute inset-2 border border-champagne/55" aria-hidden="true" />
